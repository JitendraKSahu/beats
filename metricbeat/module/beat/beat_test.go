...
import (
	...
	"github.com/jksroot/beats/v7/metricbeat/module/beat"

	// Make sure metricsets are registered in mb.Registry
	_ "github.com/jksroot/beats/v7/metricbeat/module/beat/state"
	_ "github.com/jksroot/beats/v7/metricbeat/module/beat/stats"
)
