...
import (
	...
	v1 "github.com/JitendraKSahu/beats/v7/x-pack/filebeat/input/netflow/decoder/v1"
	v5 "github.com/JitendraKSahu/beats/v7/x-pack/filebeat/input/netflow/decoder/v5"
)
