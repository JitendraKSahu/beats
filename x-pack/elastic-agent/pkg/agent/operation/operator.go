...
import (
	...
	"github.com/JitendraKSahu/beats/v7/x-pack/elastic-agent/pkg/core/plugin/process"
	"github.com/JitendraKSahu/beats/v7/x-pack/elastic-agent/pkg/core/plugin/service"
